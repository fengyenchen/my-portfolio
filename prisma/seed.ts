...
async function main() {
  ...
  await prisma.profile.create({
    data: {
      ...
      bio: "我熱衷於探索設計、程式與互動體驗之間的可能性。我喜歡從觀察使用者需求開始，透過設計思維與技術實作，將想法轉化為具有價值的數位產品與互動體驗。我相信，好的產品不只是解決問題的工具，更是連結人與人、人與科技之間的重要媒介。\n\nYen-Chen Feng is passionate about exploring the intersection of design, programming, and interactive experiences. Starting from understanding users' needs, she combines design thinking with technical implementation to transform ideas into meaningful digital products and engaging experiences."
    }
  })
    ...
    data: [
      {
        ...
        imgSrc: '/design-projects/a-promise-with-time.png', // 已對接 schema 的 imgSrc
        link: 'https://fengyenchen.github.io/my-page/arts/A%20Promise%20with%20Time/A%20Promise%20with%20Time.html',
        tags: ['漫畫', 'Illustration', '故事創作'] // 已對接 schema 的 tags 欄位名稱
      },
      {
        title: '演講海報設計',
